...
std::vector<double> charging_area_upper_left(){
  return {config["charging_area"]["upper_left"][0].as<double>(), config["charging_area"]["upper_left"][1].as<double>()};
}
std::vector<double> charging_area_down_right(){
  return {config["charging_area"]["down_right"][0].as<double>(), config["charging_area"]["down_right"][1].as<double>()};
}
